...
exports.handler = async (event) => {
  ...
  if (earlyPayload && earlyPayload.type === "tts_status") {
    return reply(200, {
      ...
      voice: process.env.GOOGLE_TTS_VOICE || DEFAULT_VOICE,
      model: process.env.GOOGLE_TTS_MODEL || DEFAULT_TTS_MODEL,
    });
  }
  ...
  if (earlyPayload && earlyPayload.type === "tts") {
    ...
    const modelName = process.env.GOOGLE_TTS_MODEL || DEFAULT_TTS_MODEL;
    const style = process.env.GOOGLE_TTS_STYLE || DEFAULT_STYLE;
