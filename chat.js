...
exports.handler = async (event) => {
  ...
  if (earlyPayload && earlyPayload.type === "tts_status") {
    return reply(200, {
      ...
      voice: process.env.GOOGLE_TTS_VOICE || "en-US-Chirp3-HD-Orus",
    });
  }
  ...
  // Optional:
  //   GOOGLE_TTS_VOICE    - defaults to a warm US male Chirp 3 HD voice.
  //                         Alternatives (all en-US-Chirp3-HD-...):
  //                           Orus     rich, narrative      <- default
  //                           Charon   deep, authoritative
  //                           Puck     bright, expressive
  //                           Fenrir   energetic, youthful
  //                           Algieba / Umbriel / Iapetus / Schedar  (also male)
  //
  ...
  if (earlyPayload && earlyPayload.type === "tts") {
    ...
    const voiceName = process.env.GOOGLE_TTS_VOICE || "en-US-Chirp3-HD-Orus";
